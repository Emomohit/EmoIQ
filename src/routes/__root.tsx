...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI tools, predicted PYQs, study plans for exams." },
      { name: "author", content: "EMoIQ" },
      { property: "og:title", content: "EMoIQ — AI-Powered Smart Exam Strategy Engine" },
